...
export function ViolationStatsHeader({ stats }: Props) {
  return (
    <div className="flex flex-wrap gap-2 w-full lg:w-auto">
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/20 bg-white/10 text-white backdrop-blur-sm shadow-sm w-full sm:w-auto">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-red-400/40 bg-red-500/20 text-white backdrop-blur-sm shadow-sm w-full sm:w-auto">
